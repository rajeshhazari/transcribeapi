...
public interface UserRepository extends CrudRepository<	Users, Long>{
	...
	Users findByUsername(String username);
	  ...
	  List<Users> findByEmailAddressAndUsernameAllIgnoreCase(String emailAddress, String username);
	  List<Users> findByEmailAddressAndusernameAndInActive(String emailAddress, String username);
